...
function CloundBase(config) {
  // console.log(config)
  this.config = config ? config : this.config
}

CloundBase.prototype.init = function ({
  secretId,
  secretKey,
  sessionToken,
  env,
  ...
  return new CloundBase(this.config);
};

CloundBase.prototype.database = function (dbConfig) {
...
extend(CloundBase.prototype, functions);
extend(CloundBase.prototype, storage);
extend(CloundBase.prototype, wx)

module.exports = new CloundBase();
